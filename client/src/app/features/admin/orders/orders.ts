...
export class Orders {
      ...
      getOrdersForPage(page: number, status: string){
        this.currentPage = page;
          this.orderSer.getAdminOrders(this.currentPage, this.itemsPerPage, status).pipe(takeUntilDestroyed(this.destryRef)).subscribe({
              next: (res)=>{
